...
#define _VAR_CAST				_MIDI_FILE *pMF = (_MIDI_FILE *)_pMF; _MIDI_FILE *pMFembedded = (_MIDI_FILE *)_pMFembedded; 
...
// ok!
int32_t midiReadGetNumTracks(const MIDI_FILE *_pMF, MIDI_FILE *_pMFembedded, BOOL embedded) {
	_VAR_CAST;
      ...
      readChunkFromFile(pMFembedded->pFile, pMsgEmbedded->dataEmbedded, bptrEmbedded, szEmbedded);
        ...
        case	metaMIDIPort:
          ...
          break;
            ...
            // embedded (TODO: looks ok!)
            {
              uint8_t temp;
              readByteFromFile(pMFembedded->pFile, &temp, pTrackNew->ptrNew + 1);
              if (temp)
                pMsgEmbedded->MsgData.MetaEvent.Data.KeySig.iKey |= keyMaskMin;
            }
					  break;
			  case	metaSequencerSpecific:
					  pMsg->MsgData.MetaEvent.Data.Sequencer.iSize = pMsg->iMsgSize;
					  pMsg->MsgData.MetaEvent.Data.Sequencer.pData = pMsg->data + 3;
...
// not needed in embedded version.
...
//////////////////////////////////////////////////////////////////////////////////////////
//                                                                                      //
// The following functions are used for generating MIDI files and are implemented later //
//                                                                                      //
//////////////////////////////////////////////////////////////////////////////////////////
